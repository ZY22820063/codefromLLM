...
# 加载数据集
train_data = pd.read_csv('train2-ts.csv')  # 替换为正确的文件路径
test_data = pd.read_csv('predict-Ts.csv')    # 替换为正确的文件路径

# 选定的特征
selected_features = ['Maximum Imidization Temperature', 'a3217380708', 'Total Imidization Time', 'g3974328374', 'Thickness-middle', 'a3162837314']
...
#train_predictions.to_csv('train_predictions-tg-tt2-6.csv', index=False)
test_predictions.to_csv('predictions-ts-tt2-6.csv', index=False)
