...
# 加载数据集
train_data = pd.read_csv('train14-tr.csv')  # 替换为正确的文件路径
test_data = pd.read_csv('predict-Tr.csv')    # 替换为正确的文件路径

# 选定的特征
selected_features = ['Wavelength (nm)', 'Maximum Imidization Temperature', 'Total Imidization Time', 
                     'Thickness-middle', 'a221403255', 'a1366143150', 'a2041434490', 'a1543552144', 'a951226070', 
                     'g2471530844', 'g864674487', 'g994485099', 'g3217380708', 'g3933537673']
...
#train_predictions.to_csv('train_predictions-tr-tt14-14.csv', index=False)
test_predictions.to_csv('predictions-tr-tt14-14.csv', index=False)
